...
if(isset($_POST['agendar'])){
    ...
    include_once 'assets/google-api-php-client-2.2.1_PHP54/vendor/autoload.php';

    //configurar variable de entorno / set enviroment variable
    $credenciales_url = 'config/credenciales_calendar/sistema-averias-credenciales.json';
    putenv('GOOGLE_APPLICATION_CREDENTIALS='.$credenciales_url);
    ...
    $id_calendar='b0dabgei7a7q8liuhi2rreg7rs@group.calendar.google.com';//
    ...
    try{
        ...
        if($cont_events == 0){
            ...
            $event->setSummary('Atender avería al usuario(a): '.$nombre);
            $event->setDescription('Avería de tubo rotísimo :3');
